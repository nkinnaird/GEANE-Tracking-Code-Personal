...
std::vector<Eigen::MatrixXd> INVmeasurementErrorMatrices;
std::vector<Eigen::MatrixXd> INVpropagatedErrorMatrices;
std::vector<Eigen::MatrixXd> INVsideDiagonalErrorMatrices;
std::vector<Eigen::MatrixXd> INVsideLowerDiagonalErrorMatrices;
...
/////////////////////////////////////////////////////////////////////////////////////
      ...
      { 
            ...
            INVmeasurementErrorMatrices.push_back(Eigen::MatrixXd::Zero(5,5));
 ...
 G4cout << " Hit U. " << G4endl;
#endif
              // INVsigmaErrorMatrices[ipl](4,4) = 1./errorMatricesGeVcm[ipl](4,4);//+1./(0.01*0.01);
              ...
              INVmeasurementErrorMatrices[ipl](4,4) = 10000.;
            }
  ...
  G4cout << " Hit V. " << G4endl;
#endif
              // INVsigmaErrorMatrices[ipl](3,3) = 1./errorMatricesGeVcm[ipl](3,3);//+1./(0.01*0.01);
              ...
              INVmeasurementErrorMatrices[ipl](3,3) = 10000.;
            }
...
/////////////////////////////////////////////////////////////////////////////////////
            ...
            INVpropagatedErrorMatrices.push_back(Eigen::MatrixXd::Zero(5,5));
            INVsideDiagonalErrorMatrices.push_back(Eigen::MatrixXd::Zero(5,5));
            INVsideLowerDiagonalErrorMatrices.push_back(Eigen::MatrixXd::Zero(5,5));

      for (int ipl = 1; ipl < maxNumPlanes-1; ++ipl)
      { 
            INVpropagatedErrorMatrices.push_back(Eigen::MatrixXd::Zero(5,5));


            Eigen::Matrix2d tempMatrix;
            tempMatrix = (myTransferMatricesGeVcm[ipl+1]*INVsigmaErrorMatrices[ipl+1]*myTransferMatricesGeVcm[ipl+1].transpose()).bottomRightCorner<2,2>();


            if (paramMeasured[3][ipl] == noHit && paramMeasured[4][ipl] != noHit)
            {
              INVpropagatedErrorMatrices[ipl](4,4) = tempMatrix(1,1);
            }

            else if (paramMeasured[4][ipl] == noHit && paramMeasured[3][ipl] != noHit)
            {
              INVpropagatedErrorMatrices[ipl](3,3) = tempMatrix(0,0);
            }
      ...
      { 
            ...
            Eigen::MatrixXd tempInvertedErrorMatrix = -errorMatricesBetweenPlanes[ipl+1].inverse();


            Eigen::MatrixXd tempMatrix2 = Eigen::MatrixXd::Zero(5,5);
            // tempMatrix2.bottomRightCorner<2,2>() = (-INVsigmaErrorMatrices[ipl+1]*myTransferMatricesGeVcm[ipl+1].transpose()).bottomRightCorner<2,2>();
                        tempMatrix2 = ((tempInvertedErrorMatrix)*myTransferMatricesGeVcm[ipl+1].transpose());

            // Eigen::MatrixXd tempMatrix3 = Eigen::MatrixXd::Zero(5,5);
            // tempMatrix3 =  tempMatrix2.transpose(); //(-myTransferMatricesGeVcm[ipl+1].transpose()*INVsigmaErrorMatrices[ipl+1]).bottomRightCorner<2,2>();



            if (paramMeasured[4][ipl] != noHit && paramMeasured[4][ipl+1] != noHit)
            {
              INVsideDiagonalErrorMatrices[ipl](4,4) = tempMatrix2(4,4);
              // INVsideDiagonalErrorMatrices[ipl] = tempMatrix2;
              // INVsideLowerDiagonalErrorMatrices[ipl] = tempMatrix3;
              INVsideLowerDiagonalErrorMatrices[ipl] = INVsideDiagonalErrorMatrices[ipl].transpose();
            }

            else if (paramMeasured[3][ipl] != noHit && paramMeasured[3][ipl+1] != noHit)
            {
              INVsideDiagonalErrorMatrices[ipl](3,3) = tempMatrix2(3,3);
              // INVsideDiagonalErrorMatrices[ipl] = tempMatrix2;
              // INVsideLowerDiagonalErrorMatrices[ipl] = tempMatrix3;
                            INVsideLowerDiagonalErrorMatrices[ipl] = INVsideDiagonalErrorMatrices[ipl].transpose();
            }

            else if (paramMeasured[4][ipl] != noHit && paramMeasured[3][ipl+1] != noHit)
            {
              INVsideDiagonalErrorMatrices[ipl](4,3) = tempMatrix2(4,3);
                            INVsideLowerDiagonalErrorMatrices[ipl] = INVsideDiagonalErrorMatrices[ipl].transpose();

            }

            else if (paramMeasured[3][ipl] != noHit && paramMeasured[4][ipl+1] != noHit)
            {
              INVsideDiagonalErrorMatrices[ipl](3,4) = tempMatrix2(3,4);
                            INVsideLowerDiagonalErrorMatrices[ipl] = INVsideDiagonalErrorMatrices[ipl].transpose();

            }
/*
            if (paramMeasured[4][ipl+2] != noHit && paramMeasured[4][ipl+1] != noHit)
            {
              INVsideLowerDiagonalErrorMatrices[ipl](4,4) = tempMatrix3(1,1);
            }

            else if (paramMeasured[3][ipl+2] == noHit && paramMeasured[3][ipl+1] != noHit)
            {
              INVsideLowerDiagonalErrorMatrices[ipl](3,3) = tempMatrix3(0,0);
            }

            if (ipl == maxNumPlanes-2) // Quick fix for last plane.
            {
              INVsideLowerDiagonalErrorMatrices[ipl](3,3) = tempMatrix3(0,0);
            }
*/
...
/////////////////////////////////////////////////////////////////////////////////////
     ...
     for (int ipl = 1; ipl < maxNumPlanes; ++ipl)
     {
      if (ipl == maxNumPlanes-1){
        combinedTotalErrorCorrelationMatrix.block(numTrackParams*(ipl-1),numTrackParams*(ipl-1),numTrackParams,numTrackParams) = INVsigmaErrorMatrices[ipl] + INVmeasurementErrorMatrices[ipl]; // Don't add the last part for the last plane.
      }
      else{
        combinedTotalErrorCorrelationMatrix.block(numTrackParams*(ipl-1),numTrackParams*(ipl-1),numTrackParams,numTrackParams) = INVsigmaErrorMatrices[ipl] + INVmeasurementErrorMatrices[ipl] + INVpropagatedErrorMatrices[ipl]; //myTransferMatricesGeVcm[ipl+1].transpose()*INVsigmaErrorMatrices[ipl+1]*myTransferMatricesGeVcm[ipl+1];
      }
     }

     for (int ipl = 1; ipl < maxNumPlanes-1; ++ipl)
     {
       combinedTotalErrorCorrelationMatrix.block(numTrackParams*(ipl-1),5+numTrackParams*(ipl-1),numTrackParams,numTrackParams) = INVsideDiagonalErrorMatrices[ipl]; //-INVsigmaErrorMatrices[ipl+1]*myTransferMatricesGeVcm[ipl+1]; // Fill just off diagonal elements except for the last one.
       combinedTotalErrorCorrelationMatrix.block(5+numTrackParams*(ipl-1),numTrackParams*(ipl-1),numTrackParams,numTrackParams) = INVsideLowerDiagonalErrorMatrices[ipl]; //-myTransferMatricesGeVcm[ipl+1].transpose()*INVsigmaErrorMatrices[ipl+1];
     }

     // G4cout << G4endl << "Combined 5N x 5N error matrix: " << G4endl << combinedTotalErrorCorrelationMatrix << G4endl;
          // G4cout << G4endl << "Combined 5N x 5N error matrix bottom right block: " << G4endl << combinedTotalErrorCorrelationMatrix.bottomRightCorner(15,15) << G4endl;
               G4cout << G4endl << "Combined 5N x 5N error matrix top left block: " << G4endl << combinedTotalErrorCorrelationMatrix.topLeftCorner(15,15) << G4endl;
